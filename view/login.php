        ...
        <div class="container-fluid ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-auto">
                    ...
                    <li class="nav-item">
                        <a href="login.php" class="active nav-link">Login</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="col-lg-12 col-md-12 col-8 d-flex flex-column justify-content-center align-items-center">
                    <div class="form-group">
                        <div class="form-heading mb-2 ">
                            <h4 class="text-secondary  font-bold ">Login</h4>
                        </div>
                        <p class="text-center font-bold text-danger">
                            <?php
                            if (isset($_GET['error'])) {
                                echo $_GET['error'];
                            }
                        ...
                        <div class="form-body mb-2 col-lg-8 col-md-6 col-10">
                        ...
                        <div class="form-end mt-2 text-center">
                            <a href="#" class=" nav-link"> <span class="text-secondary">Don't Remeber Your Password</span> Forget Password</a>
                        </div>
                    </div>
                </div>
            </div>
